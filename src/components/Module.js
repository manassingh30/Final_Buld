...
const Module = ({ module, setModules, modules, setFeedbackMessage }) => {
  ...
  const handleRenameResource = (resourceId) => {
    const updatedResources = resources.map((res) =>
      res.id === resourceId ? { ...res, title: newResourceTitle } : res
    );
                    ...
                    >
                      {resource.id === renamingResource ? (
                        <div>
                          ...
                          />
                          <button
                            onClick={() => handleRenameResource(resource.id)}
                            style={{
                              backgroundColor: "black",
                              float: "unset",
                              padding: "7px",
